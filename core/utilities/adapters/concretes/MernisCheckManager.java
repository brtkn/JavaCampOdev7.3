...
public class MernisCheckManager implements MernisCheckService {
	...
	public Result checkIfRealPerson(JobCandidate jobCandidate) throws Exception {
		...
		boolean result = kpsPublicSoapProxy.TCKimlikNoDogrula(Long.parseLong(jobCandidate.getNationalityId()), jobCandidate.getFirstName().toUpperCase(new Locale("tr","TR")), jobCandidate.getLastName().toUpperCase(new Locale("tr","TR")),Integer.parseInt(jobCandidate.getYearOfBirth()));
